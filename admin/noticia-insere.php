...
if(isset($_POST['inserir'])){
	...
	/* capturando dados do arquivo através 
	do array superGlobal $_FILES */
	$imagem = $_FILES['imagem'];

	// Executar a funçao de upload do ARQUIVO
	upload($imagem);

	// inserir os dados do banco (atenção ao nome da imagem).
...
<div class="row">
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		<!-- ATRIBUTO VALENDO MULTIPART/FORM-DATA
		NECESSÁRIO em formulários que receberão ARQUIVOS (imagens,
		documentos, pdfs, planilhas) para processamento. -->
